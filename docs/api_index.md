...
|-------------|----------------|
| PhysicsSystem, init, update, body interface, constraints | [`#physicssystem`](jolt_api.md#physicssystem) |
| BodyInterface, create body, add body, destroy body, set position | [`#bodyinterface`](jolt_api.md#bodyinterface) |
| BodyCreationSettings, shape, position, rotation, motion type | [`#bodycreationsettings`](jolt_api.md#bodycreationsettings) |
| ObjectLayerFilter, should collide, layer filtering | [`#objectlayerfilter`](jolt_api.md#objectlayerfilter) |
| ConstraintSettings, constraint priority, enabled, user data | [`#constraintsettings`](jolt_api.md#constraintsettings) |
